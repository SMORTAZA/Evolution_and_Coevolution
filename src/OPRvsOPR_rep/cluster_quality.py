...
from math import *
import glob
sys.path.append('/data/mortaza/src/16S_rep/')
...
/data/mortaza/src/OPRvsOPR_rep/cluster_quality.py out.opr_vs_opr_0.001.txt.I50 /data/mortaza/Lucifer/oprvsgenome/OPRs_fasta/fasta_files
